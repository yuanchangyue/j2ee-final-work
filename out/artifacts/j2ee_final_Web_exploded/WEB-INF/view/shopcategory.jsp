        ...
        <div class="content-wrapper">
            <div class="row page-tilte align-items-center">
                <div class="col-md-auto">
                    ...
                    <h1 class="weight-300 h3 title">商铺类别管理</h1>
                    <p class="text-muted m-0 desc">商铺类别列表如下</p>
                </div>
                <div class="col controls-wrapper mt-3 mt-md-0 d-none d-md-block ">
                    <div class="controls d-flex justify-content-center justify-content-md-end">
                        <input type="search" class="form-control d-inline-block" id="input-shop-category-name"
                               placeholder="输入商铺类别名称">
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table  m-0">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="border-top-0 text-center">商铺类别名称</th>
                            <th scope="col" class="border-top-0 text-center">商铺类别描述</th>
                            <th scope="col" class="border-top-0 text-center">商铺类别优先权</th>
                            <th scope="col" class="border-top-0 text-center">创建时间</th>
                            <th scope="col" class="border-top-0 text-center">操作</th>
                        </tr>
                        </thead>
                        <tbody id="shop-category-tbody">
                ...
                <form action="" id="category-form" data-parsley-validate="">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="shopCategoryName">商铺类别名称</label>
                            <input type="text" class="form-control" name="shopCategoryName" id="shopCategoryName"
                                   placeholder="请输入商铺类别名称"
                                   data-parsley-required="true"
                                   data-parsley-length="[1, 11]"
                                   data-parsley-trigger="blur"
                            >
                        </div>
                        <div class="form-group">
                            <label for="shopCategoryDesc">商铺类别描述</label>
                            <input type="text" class="form-control" name="shopCategoryDesc" id="shopCategoryDesc"
                                   placeholder="请输入商铺类别描述"
                                   data-parsley-required="true"
                                   data-parsley-length="[1, 11]"
                                   data-parsley-trigger="blur"
                            >
...
<script src="${pageContext.request.contextPath}/static/js/shopcategory.js"></script>
